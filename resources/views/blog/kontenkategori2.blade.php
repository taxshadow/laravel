									...
									<div class="col-sm-12">
										<div class="blog-post small">
											<div class="post-header">
												<p class="categories"><a href="#">{{$row->kategori->namakategori}}</a></p>

												<h2 class="post-title">
													<a href="/laravel/public/blog/{{$row->slug}}">{{$row->judulartikel}}</a>
												</h2>

												<ul class="post-meta">
													<li class="date">{{ date('d F Y', strtotime($row->created_at)) }}</li>
													<li class="author">by <a href="{{ url('blog/author/'.$row->user_id.'')}}">{{$row->user->name}}</a></li>
											...
											<div class="post-cover">
												<a href="blog-post.html">
													<img max-width="367" max-height="346" src="{{asset('image/thumb_'.$row->image)}}" alt="simple post cover" />
												</a>
											</div>
											...
											<div class="post-body">
												...
												<div class="align-center">
													<a href="/laravel/public/blog/{{$row->slug}}" class="btn template-btn-2">Read more</a>
												</div>
											</div>
										</div>
									</div>
